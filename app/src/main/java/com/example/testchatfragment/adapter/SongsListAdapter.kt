package com.example.testchatfragment.adapter
...
import com.example.testchatfragment.MyExoplayer
import com.example.testchatfragment.PlayerActivity
import com.example.testchatfragment.databinding.SongListItemRecyclerRowBinding
                ...
                .addOnSuccessListener {
                    ...
                    song?.apply {
                        ...
                        binding.root.setOnClickListener{
                            MyExoplayer.startPlay(binding.root.context,song)
                            it.context.startActivity(Intent(it.context, PlayerActivity::class.java)) //will navigasi to player activity
                        }
                    }
                }
